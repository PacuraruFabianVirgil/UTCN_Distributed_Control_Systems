...
public class FuzzyDefuzzy {
    ...
    public FuzzyDefuzzy(double negativeLimit,
                        double negativeMiddleValue, double zero,
                        double positiveMiddleValue,
                        double positiveLimit) {
        limits = new EnumMap<FuzzyValue, Double>(FuzzyValue.class);
        limits.put(FuzzyValue.NL, negativeLimit);
        limits.put(FuzzyValue.NM, negativeMiddleValue);
        limits.put(FuzzyValue.ZR, zero);
        limits.put(FuzzyValue.PM, positiveMiddleValue);

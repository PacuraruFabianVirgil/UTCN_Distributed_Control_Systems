...
public class Lanes_Intersection {
	public static void main(String[] args) {
		...
		DataTransfer p26 = new DataTransfer();
		p26.SetName("P_o4Network");
		p26.Value = new TransferOperation("localhost", "1081", "P1");
...
//		t2.Delay = 3;
		...
		grdT31.Activations.add(new Activation(t3, "full", TransitionOperation.SendOverNetwork, "OP2"));
		grdT31.Activations.add(new Activation(t3, "P_a2", TransitionOperation.Move, "P_a2"));
		...
		grdT51.Activations.add(new Activation(t5, "full", TransitionOperation.SendOverNetwork, "OP3"));
		grdT51.Activations.add(new Activation(t5, "P_a3", TransitionOperation.Move, "P_a3"));
		...
		grdT71.condition = T7Ct3;
		grdT71.Activations.add(new Activation(t7, "full", TransitionOperation.SendOverNetwork, "OP4"));
		grdT71.Activations.add(new Activation(t7, "P_a4", TransitionOperation.Move, "P_a4"));
		t1.GuardMappingList.add(grdT1);
		...
		t21.TransitionName = "T_g4Network";
		...
		grdT21.Activations.add(new Activation(t21, "P_o4Exit", TransitionOperation.SendOverNetwork, "P_o4Network"));

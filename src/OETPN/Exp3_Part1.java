...
public class Exp3_Part1 {
	...
	public static PetriNet PN4() {
		...
		lstInput.add("constantVal1");
		grdT31.Activations.add(new Activation(t31, lstInput, TransitionOperation.Add, "p36"));
		grdT31.Activations.add(new Activation(t31, "p31", TransitionOperation.Move, "p32"));
		...
		Condition T33Ct1 = new Condition(t33, "p34", TransitionCondition.LessThan, "constantVal2");
	...
	public static void main(String[] args) {
		...
		DataFloat constantVal3 = new DataFloat();
		constantVal3.SetName("constantVal3");
		constantVal3.SetValue(2.0f);
		pn.ConstantPlaceList.add(constantVal3);
		...
		Condition T1Ct2 = new Condition(t1, "p2", TransitionCondition.LessThan, "constantVal3");
		...
		Condition T1Ct4 = new Condition(t1, "p2", TransitionCondition.MoreThanOrEqual, "constantVal3");
		T1Ct3.SetNextCondition(LogicConnector.AND, T1Ct4);

		GuardMapping grdT11 = new GuardMapping();
		grdT11.condition = T1Ct3;

		grdT11.Activations.add(new Activation(t1, "PN4", TransitionOperation.Copy, "p3"));
		grdT11.Activations.add(new Activation(t1, "p1", TransitionOperation.Move, "p4"));
		grdT11.Activations.add(new Activation(t1, "p2", TransitionOperation.Move, "p3-p31"));
